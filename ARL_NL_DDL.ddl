...
DROP TABLE NL_ARL_Empy CASCADE CONSTRAINTS ;
...
CREATE UNIQUE INDEX NL_ARL_Empy__IDX ON NL_ARL_Empy
  (
    NL_Member_member_id ASC
  )
  ;
  ALTER TABLE NL_ARL_Empy ADD CONSTRAINT NL_ARL_Empy_PK PRIMARY KEY ( user_id ) ;
...
CREATE TABLE NL_Member
  (
    ...
    type                VARCHAR2 (255) ,
    date_added          DATE ,
    NL_ARL_Empy_user_id INTEGER
  ) ;
CREATE UNIQUE INDEX NL_Member__IDX ON NL_Member
  (
    NL_ARL_Empy_user_id ASC
  )
  ;
...
ALTER TABLE NL_NL ADD CONSTRAINT NL_NL_PK PRIMARY KEY ( nl_id ) ;
...
CREATE TABLE NL_lab
  ( lab_id INTEGER NOT NULL , name VARCHAR2 (4000)
  ) ;
ALTER TABLE NL_lab ADD CONSTRAINT NL_lab_PK PRIMARY KEY ( lab_id ) ;

ALTER TABLE NL_ARL_Empy ADD CONSTRAINT NL_ARL_Empy_NL_Member_FK FOREIGN KEY ( NL_Member_member_id ) REFERENCES NL_Member ( member_id ) ;
...
ALTER TABLE NL_Mem_NL ADD CONSTRAINT NL_Mem_NL_NL_NL_FK FOREIGN KEY ( NL_NL_nl_id ) REFERENCES NL_NL ( nl_id ) ;

ALTER TABLE NL_Mem_NL ADD CONSTRAINT NL_Mem_NL_NL_NL_FKv1 FOREIGN KEY ( NL_NL_nl_id1 ) REFERENCES NL_NL ( nl_id ) ;

ALTER TABLE NL_Member ADD CONSTRAINT NL_Member_NL_ARL_Empy_FK FOREIGN KEY ( NL_ARL_Empy_user_id ) REFERENCES NL_ARL_Empy ( user_id ) ;
